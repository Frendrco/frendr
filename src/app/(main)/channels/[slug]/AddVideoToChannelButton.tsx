  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="inline-flex h-9 items-center gap-2 rounded-full border border-border bg-background px-4 font-sans font-medium text-sm text-foreground hover:bg-foreground/5 transition-colors"
      >
        <Plus size={14} />
        Add Video
      </button>
      ...
      {open && (
        <div style={dropdownStyle} className="absolute right-0 top-11 z-50 w-80 overflow-hidden rounded-xl border border-border bg-background shadow-lg dark:shadow-black/30">
              ...
              results.map((video) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate font-sans text-sm text-foreground">{video.title}</p>
